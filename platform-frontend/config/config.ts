...
export default defineConfig({
  base: isDev() ? '/pages/' : '/api-platform/pages/',
  publicPath: getPublicPath(), // 开发模式时，public目录也是这个前缀
  /**
   * @name 开启 hash 模式
  ...
  headScripts: [
    // 解决首次加载时白屏的问题
    {
      src: `${getPublicPath()}scripts/loading.js`,
      async: true,
    },
  ],
  //================ pro 插件配置 =================
  ...
  openAPI: [
    ...
    // },
    {
      ...
      schemaPath: 'http://localhost:9000/api-platform/v3/api-docs',
  ...
  //   //---------------------------------js END----------------------------------------//;
  //   //---------------------------------css END----------------------------------------//;
  //   config.plugins.get('mini-css-extract-plugin').set('args', [{ filename: 'css/[name].css' }]);
  //   //---------------------------------css END----------------------------------------//;
